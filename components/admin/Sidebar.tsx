...
function getNavItems(role: string) {
  ...
  if (role === 'Owner') {
    ...
    items.push({ href: '/admin/recordatorios', label: 'Recordatorios', icon: (
    ...
    items.push({ href: '/admin/caja', label: 'Caja', icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
    ) })
  }
  return items
}
