...
const categories: Record<string, Omit<CategoryDef, 'id'>> = {
  barberia: {
    ...
    heroTitleEm: 'online en minutos.',
    landingVertical: 'peluquerías de barrio & barberías independientes',
    theme: {
      ink: '#1a1a1a',
      ink80: '#2c2c2c',
      ink60: '#4a4a4a',
  ...
  clinica: {
    ...
    heroTitleEm: 'online en minutos.',
    landingVertical: 'clínicas & consultorios médicos',
    theme: {
      ink: '#1a2332',
      ink80: '#2c3a4f',
      ink60: '#4a5d78',
  ...
  estetica: {
    ...
    heroTitleEm: 'online en minutos.',
    landingVertical: 'centros de estética & nail bars',
    theme: {
      ink: '#2d1b2e',
      ink80: '#423045',
      ink60: '#5e4b60',
  ...
  hairimplants: {
    ...
    heroTitleEm: 'online en minutos.',
    landingVertical: 'clínicas de implantes capilares',
    theme: {
      ink: '#1a2e1a',
      ink80: '#2c452c',
      ink60: '#4a624a',
